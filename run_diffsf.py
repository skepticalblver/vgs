        ...
        for line in lines_pl:  #read in entire file and separate by column
                ...
                if initial:  #initialize values of each gas speices
                        if target_i == target_i_file:
                                ...
                                water_a=1e20# target_m*SF.water_mf(target_au)*0.005
                                carbon_a=1e20 #target_m*SF.carbon_mf(target_au)*0.005
                                nitrogen_a= 1e20#target_m*SF.nitrogen_mf(target_au)*0.005
                                carbon_c = 1e16				
...
with open('reference/OUT_ATM_diffsf', 'w') as f2:
...
with open('reference/OUT_MANT_diffsf', 'w') as f4:
